<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"../oscshop/install/view/install/step1.html";i:1505885316;s:40:"../oscshop/install/view/public/base.html";i:1505885316;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container" style="background: white;margin-top: 50px;margin-bottom: 50px;width:800px">
    ...
    <a class="btn btn-block btn-primary btn-large" href="<?php echo url('Install/step2'); ?>">下一步</a>
    <a class="btn btn-default btn-block btn-large" style="background: white;" href="<?php echo url('Index/index'); ?>">上一步</a>
