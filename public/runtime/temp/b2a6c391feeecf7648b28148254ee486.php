<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"../oscshop/install/view/install/step2.html";i:1505885316;s:40:"../oscshop/install/view/public/base.html";i:1505885316;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container" style="background: white;margin-top: 50px;margin-bottom: 50px;width:800px">
    ...
    <li><a href="javascript:;">
        <?php if(\think\Session::get('update') == '1'): ?>升级
            <?php else: ?>
            安装
        <?php endif; ?>
    </a></li>
    ...
    <form action="<?php echo url('Install/step2'); ?>" method="post" target="_self">
        <div class="create-database">
            ...
            <table class="table-hover table">
                ...
                <tr>
                    <td>
                        <input class="form-control" type="text" name="db[]"
                               value="<?php if(defined("SAE_MYSQL_HOST_M")): ?><?php echo SAE_MYSQL_HOST_M; else: ?>127.0.0.1<?php endif; ?>">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-control" type="text" name="db[]"
                               value="<?php if(defined("SAE_MYSQL_DB")): ?><?php echo SAE_MYSQL_DB; endif; ?>">
                    </td>
                    <td>
                        <span>数据库名</span>
                    </td>
                ...
                <tr>
                    <td>
                        <input class="form-control" type="text" name="db[]"
                               value="<?php if(defined("SAE_MYSQL_USER")): ?><?php echo SAE_MYSQL_USER; endif; ?>">
                    </td>
                    <td>
                        <span>数据库用户名</span>
                    </td>
                ...
                <tr>
                    <td>
                        <input class="form-control" type="password" name="db[]"
                               value="<?php if(defined("SAE_MYSQL_PASS")): ?><?php echo SAE_MYSQL_PASS; endif; ?>">
                    </td>
                    <td>
                        <span>数据库密码</span>
                    </td>
                ...
                <tr>
                    <td>
                        <input class="form-control" type="text" name="db[]"
                               value="<?php if(defined("SAE_MYSQL_PORT")): ?><?php echo SAE_MYSQL_PORT; else: ?>3306<?php endif; ?>">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-control" type="text" name="db[]" value="osc_">
                    </td>
                    <td>
    ...
    <a class="btn btn-large btn-block btn-default" style="background: white;" href="<?php echo url('Install/step1'); ?>">上一步</a>
