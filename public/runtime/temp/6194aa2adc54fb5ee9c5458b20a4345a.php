<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"../oscshop/member/view/auth_backend/edit_group.html";i:1505890083;s:38:"../oscshop/admin/view/public/base.html";i:1505885316;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<div class="col-xs-12">	
		<div class="form-horizontal">
			...
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="用户组" name="title"  value="<?php echo (isset($group['title']) && ($group['title'] !== '')?$group['title']:''); ?>" />
				</div>
			</div>			
			...
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="描述" name="description"  value="<?php echo (isset($group['description']) && ($group['description'] !== '')?$group['description']:''); ?>" />
				</div>
			</div>
