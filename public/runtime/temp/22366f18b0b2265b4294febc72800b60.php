<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"../oscshop/admin/view/auth_manager/index.html";i:1507895017;s:38:"../oscshop/admin/view/public/base.html";i:1508162033;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('AuthManager/create_group'); ?>" class="btn btn-primary"><?php echo lang('新增用户组'); ?></a>
</div>		
