<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"../oscshop/mobile/view/agent_backend/agent_list.html";i:1505890083;s:38:"../oscshop/admin/view/public/base.html";i:1505885316;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
			...
			<table id="table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>		
							...
							<td><a href="<?php echo url('AgentBackend/sub_member',array('uid'=>$v['uid'])); ?>"> <?php echo (isset($v['member']) && ($v['member'] !== '')?$v['member']:'0'); ?>人 </a></td>
							<td><a href="<?php echo url('AgentBackend/sub_order',array('uid'=>$v['uid'])); ?>"> <?php echo (isset($v['order']) && ($v['order'] !== '')?$v['order']:'0'); ?>笔 </a></td>
							<td><span class="red bold">￥<?php echo (isset($v['month']) && ($v['month'] !== '')?$v['month']:'0.00'); ?></span></td>
							<td><span class="red bold">￥<?php echo (isset($v['total_bonus']) && ($v['total_bonus'] !== '')?$v['total_bonus']:'0.00'); ?></span></td>
							<td><span class="red bold">￥<?php echo (isset($v['no_cash']) && ($v['no_cash'] !== '')?$v['no_cash']:'0.00'); ?></span></td>
							<td>
								<?php switch($v['status']): case "1": ?><span class="green bold">开启</span><?php break; case "0": ?><span class="red bold">关闭</span><?php break; endswitch; ?>
							</td>
							<td>
								<a href="<?php echo url('AgentBackend/edit_agent',array('id'=>$v['agent_id'])); ?>">编辑</a>
							</td>
						</tr>
						...
						<tr>
							<td colspan="20" class="page">总计 <?php echo ($page->total() ?: "0"); ?> 个代理</td>
						</tr>
				</tbody>
