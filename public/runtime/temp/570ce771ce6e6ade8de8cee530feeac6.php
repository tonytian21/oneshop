<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"../oscshop/admin/view/option/index.html";i:1507903533;s:38:"../oscshop/admin/view/public/base.html";i:1507895017;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('Option/add'); ?>" class="btn btn-primary"><?php echo lang('新增选项'); ?></a>
</div>	
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>											
						<th><?php echo lang('选项名称'); ?></th>
						<th><?php echo lang('英文选项名称'); ?></th>
						<th><?php echo lang('选项值'); ?></th> 
						<th><?php echo lang('英文选项值'); ?></th> 
				...
				<tbody>
						...
						<tr>		
							...
							<td><?php echo $o['name_en']; ?></td>	
							<td><?php echo $o['value']; ?></td>	
							<td><?php echo $o['value_en']; ?></td>	
							<td>								
							<?php switch($o['type']): case "select": ?><?php echo lang('下拉列表'); break; case "radio": ?><?php echo lang('单选组'); break; case "checkbox": ?><?php echo lang('多选组'); break; endswitch; ?>
							</td>				
							<td>
