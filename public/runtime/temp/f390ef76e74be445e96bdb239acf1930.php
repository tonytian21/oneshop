<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"../oscshop/admin/view/weight_class/index.html";i:1507895017;s:38:"../oscshop/admin/view/public/base.html";i:1507895017;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('weight_class/add'); ?>" class="btn btn-primary"><?php echo lang('新增'); ?></a>
</div>	
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>											
						<th><?php echo lang('重量名称'); ?></th>
						<th><?php echo lang('重量单位'); ?></th> 
						<th><?php echo lang('值'); ?>(1kg<?php echo lang('换算为该单位的值'); ?>)</th>  
