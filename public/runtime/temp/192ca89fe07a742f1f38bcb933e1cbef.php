<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"../oscshop/member/view/account/profile.html";i:1505885316;s:41:"../oscshop/member/view/public/member.html";i:1505885316;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">	
		<div class="form-horizontal">	
			...
			<div class="col-sm-10">
				 <div id="thumb">
		                  <a href="#" id="thumb-icon" data-toggle="image" class="img-thumbnail">
		                  	<?php if($user['userpic']): ?>
		                  		<img src="IMG_ROOT<?php echo resize($user['userpic'],100,100); ?>" />
		                  	<?php else: ?>
		                  		<img src="__PUBLIC__/image/no_image_100x100.jpg" />
		                  	<?php endif; ?>
						  </a>
		                  <input type="hidden" name="userpic" value="<?php echo (isset($user['userpic']) && ($user['userpic'] !== '')?$user['userpic']:''); ?>" id="input-image" />
		            </div>
			</div>
			</div>
			...
			<div class="col-sm-5">
				<div class="clearfix">
					<input name="nickname" class="col-xs-10 col-sm-10 form-control"  value="<?php echo (isset($user['nickname']) && ($user['nickname'] !== '')?$user['nickname']:''); ?>" type="text">
				</div>
			</div>
			</div>
			...
			<div class="col-sm-5">
				<div class="clearfix">
					<input name="email" class="col-xs-10 col-sm-10 form-control"  value="<?php echo (isset($user['email']) && ($user['email'] !== '')?$user['email']:''); ?>" type="text">
				</div>
			</div>
			</div>
