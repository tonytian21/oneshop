<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"../oscshop/admin/view/attribute/index.html";i:1507904332;s:38:"../oscshop/admin/view/public/base.html";i:1507895017;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('Attribute/add'); ?>" class="btn btn-primary"><?php echo lang('新增属性'); ?></a>
</div>	
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>											
						<th><?php echo lang('属性名称'); ?></th>
						<th><?php echo lang('属性英文名称'); ?></th>
						<th><?php echo lang('属性值'); ?></th> 
						<th><?php echo lang('属性英文值'); ?></th> 
