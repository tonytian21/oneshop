<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"../oscshop/admin/view/brand/index.html";i:1506516777;s:38:"../oscshop/admin/view/public/base.html";i:1506516777;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
				...
				<tbody>
						...
						<tr>							
							...
							<?php if($data['image']): ?>
		                  	...
		                  	<?php else: ?>
		                  		<img src="__PUBLIC__/image/no_image_100x100.jpg" title="暂无图片" />
		                  	<?php endif; ?>
							</td>
