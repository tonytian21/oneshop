<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"../oscshop/admin/view/brand/index.html";i:1507899196;s:38:"../oscshop/admin/view/public/base.html";i:1507895017;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('brand/add'); ?>" class="btn btn-primary"><?php echo lang('新增'); ?></a>
</div>	
			...
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>		
						...
						<th><?php echo lang('品牌名称'); ?></th>		
						<th><?php echo lang('英文品牌名称'); ?></th>				
				...
				<tbody>
						...
						<tr>							
							<td>
							<?php if($data['image']): ?>
		                  		<img src="IMG_ROOT<?php echo resize($data['image'],100,100); ?>" title="<?php echo $data['name']; ?>" />
		                  	<?php else: ?>
		                  		<img src="__PUBLIC__/image/no_image_100x100.jpg" title="<?php echo lang('暂无图片'); ?>" />
		                  	<?php endif; ?>
							</td>
