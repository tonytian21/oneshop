<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"../oscshop/mobile/view/reply_backend/news.html";i:1505890083;s:38:"../oscshop/admin/view/public/base.html";i:1505885316;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
<a href="<?php echo url('ReplyBackend/news_add'); ?>" class="btn btn-primary">新增</a>
</div>	
						...
						<tr>
							...
							<td>
								...
								<?php if($data['thumb']): ?>
			                  	...
			                  	<?php else: ?>
			                  		<img src="__PUBLIC__/image/no_image_50x50.jpg" title="暂无图片" />
			                  	<?php endif; ?>
							</td>
							<td>
