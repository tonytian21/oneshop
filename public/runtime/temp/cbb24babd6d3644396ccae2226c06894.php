<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"../oscshop/mobile/view/reply_backend/news.html";i:1507895017;s:38:"../oscshop/admin/view/public/base.html";i:1508162033;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
<a href="<?php echo url('ReplyBackend/news_add'); ?>" class="btn btn-primary"><?php echo lang('新增'); ?></a>
</div>	
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>											
						<th><?php echo lang('关键字'); ?></th>
						<th><?php echo lang('标题'); ?></th>
						<th><?php echo lang('图片'); ?></th>
						<th>URL</th>
						<th><?php echo lang('启用'); ?></th>
				...
				<tbody>
						...
						<tr>
							...
							<td>
								...
								<?php if($data['thumb']): ?>
		                  			<img src="IMG_ROOT<?php echo resize($data['thumb'],100,100); ?>"  />
			                  	<?php else: ?>
			                  		<img src="__PUBLIC__/image/no_image_50x50.jpg" title="<?php echo lang('暂无图片'); ?>" />
			                  	<?php endif; ?>
							</td>
							<td>
								<a target="_blank" href="<?php echo request()->domain().'/mobile/article/index/id/'.$data['nr_id']; ?>">
								<?php echo request()->domain().'/mobile/article/index/id/'.$data['nr_id']; ?>
								</a>								
							</td>
							<td>
								<?php switch($data['status']): case "1": ?><?php echo lang('是'); break; case "0": ?><?php echo lang('否'); break; endswitch; ?>
							</td>
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("ReplyBackend/news_edit",array("id"=>$data["nr_id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("ReplyBackend/news_del",array("id"=>$data["rid"])); ?>' >
