<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"../oscshop/mobile/view/reply_backend/text.html";i:1507895017;s:38:"../oscshop/admin/view/public/base.html";i:1508162033;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('ReplyBackend/text_add'); ?>" class="btn btn-primary"><?php echo lang('新增'); ?></a>
</div>	
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>
							<td colspan="20" class="page"><?php echo lang('总计'); ?> <?php echo ($list->total() ?: "0"); ?> </td>
						</tr>
				</tbody>
