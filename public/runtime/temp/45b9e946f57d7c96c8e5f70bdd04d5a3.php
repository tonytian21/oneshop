<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"../oscshop/member/view/order_status/index.html";i:1507895017;s:38:"../oscshop/admin/view/public/base.html";i:1508162033;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('order_status/add'); ?>" class="btn btn-primary"><?php echo lang('新增'); ?></a>
</div>	
